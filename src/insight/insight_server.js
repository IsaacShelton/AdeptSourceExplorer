...
var wasmBinaryFile;
wasmBinaryFile = 'insight_server.wasm';
...
var ASM_CONSTS = {
    ...
    36583: () => {
        return process.arch == 'arm64' ? 1 : 0;
    },
    36624: () => {
        return process.arch == 'x64' ? 1 : 0;
    },
    36663: () => {
        return process.platform == 'linux' ? 1 : 0;
    },
};
function node_path_resolve(filename) {
...
function node_fs_existsSync(filename) {
    var fs = require('fs');
    return fs.existsSync(UTF8ToString(filename)) ? 1 : 0;
}
function node_fs_readFileSync(filename, will_append_newline) {
    var fs = require('fs');
    try {
...
function node_fs_readFileSync_binary_hex(filename) {
    var fs = require('fs');
    var contents;
    try {
...
var asmLibraryArg = {
    ...
    fd_seek: _fd_seek,
    fd_write: _fd_write,
    node_fs_existsSync: node_fs_existsSync,
    node_fs_readFileSync: node_fs_readFileSync,
    node_fs_readFileSync_binary_hex: node_fs_readFileSync_binary_hex,
    node_path_resolve: node_path_resolve,
};
var asm = createWasm();
/** @type {function(...*):?} */
...
/** @type {function(...*):?} */
var _server_main = (Module['_server_main'] = createExportWrapper('server_main'));
...
var ___start_em_js = (Module['___start_em_js'] = 36710);
var ___stop_em_js = (Module['___stop_em_js'] = 37722);
