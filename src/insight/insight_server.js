...
var ASM_CONSTS = {
  36488: () => { return process.platform == 'win32' ? 1 : 0 },  
 36535: () => { return process.platform == 'darwin' ? 1 : 0 },  
 36583: () => { return process.arch == 'arm64' ? 1 : 0 },  
 36624: () => { return process.arch == 'x64' ? 1 : 0 },  
 36663: () => { return process.platform == 'linux' ? 1 : 0 }
};
